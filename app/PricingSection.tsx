      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          ...
          <div className="bg-white rounded-2xl border-2 border-blue-600 p-8 relative shadow-xl shadow-blue-200/40">
            ...
            <p className="text-gray-500 text-sm mb-4">{PLANS.premium.description[lang]}</p>
            <div className="mb-2">
              <span className="text-lg text-gray-400 line-through mr-2">{PLANS.premium.originalPrice[lang]}</span>
            ...
            <p className="text-xs font-bold text-red-500 mb-6 flex items-center gap-1">
