...
export const metadata: Metadata = {
  title: 'Mauritius — Hotels, Restaurants, Tours & Businesses',
  description: 'Discover the best businesses across Mauritius — hotels, restaurants, spas, tours, car rentals and retail. AI-analyzed reviews, verified listings, direct booking.',
  openGraph: {
    title: 'Mauritius — Businesses & Travel Directory',
    description: '200+ verified Mauritian businesses with AI-powered insights, reviews and reputation data.',
  },
}
